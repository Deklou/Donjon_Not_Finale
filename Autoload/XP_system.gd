...
func gain_xp():
	...
	GameData.player_XP_buffer = GameData.player_XP + xp_result
	gain_level()
...
func gain_level():
	if GameData.player_XP_buffer >=100:
		...
		GameData.player_LVL_buffer = GameData.player_LVL_buffer + 1
		GameData.player_MAX_HP_buffer = GameData.player_MAX_HP_buffer + 1
