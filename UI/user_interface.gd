...
@onready var enemy_str_node : HBoxContainer = $MarginContainer_left/white_bg_left/interface_left/Enemy_Profil/Enemy_Stats/STR_HBoxContainer
@onready var enemy_dex_node : HBoxContainer = $MarginContainer_left/white_bg_left/interface_left/Enemy_Profil/Enemy_Stats/DEX_HBoxContainer
@onready var enemy_def_node : HBoxContainer = $MarginContainer_left/white_bg_left/interface_left/Enemy_Profil/Enemy_Stats/DEF_HBoxContainer
...
@onready var delimiter_3 : Sprite2D = $MarginContainer_left/white_bg_left/interface_left/Enemy_Profil/Delimiter/delimiter_3
@onready var delimiter_4 : Sprite2D = $MarginContainer_left/white_bg_left/interface_left/Enemy_Profil/Delimiter/delimiter_4
...
func tutorial_begin():
	...
	var UI_delimiter_array : Array = [delimiter_1, delimiter_2,delimiter_3,delimiter_4]
...
func tutorial_end():
	...
	var UI_enemy_stats_array : Array = [enemy_mt_node,enemy_crt_node,enemy_str_node,enemy_dex_node,enemy_def_node,enemy_hp_bar_node]
	var UI_delimiter_array : Array = [delimiter_1, delimiter_2,delimiter_3,delimiter_4]
	for node in UI_player_stats_array:
		node.visible = true
	for node in UI_enemy_stats_array:
